            ...
            <section id="account-section" className="aqa">
                <div className="aqa-grid">
                    ...
                    <div className="aqa__card">
                        <h2 id="aqa-title" className="aqa-title">Account Quick Access</h2>

                        <p className="aqa-description">
                            Secure sign-in for UF students — authenticate with your @ufl.edu email to access buying,
                            selling, messaging, and reviews.
                        </p>
                            ...
                            <Link to="/login">
                                <div className="aqa-link aqa-link-primary">
                                    ...
                                    <div className="aqa-link-content">
                                        <span className="aqa-link-title">Already have an account?</span>
                                        <span className="aqa-link-subtitle">Log in to manage listings and messages</span>
                                    </div>
                                </div>
                            </Link>
                            ...
                            <Link to="/signup">
                                <div className="aqa-link">
                                    ...
                                    <div className="aqa-link-content">
                                        ...
                                        <span className="aqa-link-subtitle">Register with your UF credentials</span>
                                    </div>
                                </div>
                            </Link>
                            ...
                            <Link to="/settings">
                                <div className="aqa-link">
                                    ...
                                    <div className="aqa-link-content">
                                        ...
                                        <span className="aqa-link-subtitle">Visit Account Settings</span>
                                    </div>
                                </div>
                            </Link>
                    ...
                    <aside className="aqa__action">
                        ...
                        <div className="aqa-action-header">
                            ...
                            <p className="aqa-action-description">
                                Post a listing in minutes — upload photos, set pricing, and reach fellow students.
                            </p>
                        </div>
