...
def main():
    ...
    testListing = addListing(listing_number=1, title="Used Toilet", description="Slightly used toilet, minor poop stains", price=100, image_location = "file/test", rating = 4, category = "product", original_poster = "sarah123")
