...
def addListing(listing_number, title, description, price):
     #Add a single listing to the database

    date_created = date.today


    obj, created = Listing.objects.get_or_create(listing_number=listing_number, defaults={"title": title, "description": description, "date_created": date_created, "price": price}) #Use ORM to create the listing 
